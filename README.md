...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-5scz4so.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-5scz4so.containers.anotherwebservice.com/
...
```
git clone git@github.com:akkharaphopmakanat/container-5scz4so.git
cd container-5scz4so
```
...
```
docker attach container-5scz4so
```
